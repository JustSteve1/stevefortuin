    ...
    <section id="home" className="min-h-screen flex items-center hero-gradient">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl animate-fade-in">
          <p className="text-teal font-medium mb-3">Hello, I'm</p>
          ...
          <h2 className="text-2xl md:text-3xl font-medium text-foreground/80 mb-6">
            Professional <span className="text-teal">Portfolio</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button className="bg-teal hover:bg-teal-dark text-white flex items-center gap-2 px-6">
